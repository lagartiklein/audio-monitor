...
class NativeAudioClient {
    ...
    private val clientId = UUID.randomUUID().toString()  // ID único persistente
    ...
    private fun startAutoReconnect() {
        ...
        reconnectJob = CoroutineScope(Dispatchers.IO).launch {
            ...
            while (!shouldStop && !isConnected && rfMode) {
                ...
                Log.d(TAG, "🔄 Intento de reconexión RF #$attempt (delay: ${currentReconnectDelay}ms)")
        ...
        try {
            ...
            val floatArray: FloatArray = if (isInt16) {
                ...
                if (shortCount % activeChannels.size != 0) {
                    ...
                    Log.e(TAG, "❌ Int16 count inválido: $shortCount shorts, ${activeChannels.size} canales")
                ...
                // Convertir Int16 [-32767, 32767] → Float32 [-1.0, 1.0]
                ...
                if (floatCount % activeChannels.size != 0) {
                    ...
                    Log.e(TAG, "❌ Float count inválido: $floatCount floats, ${activeChannels.size} canales")
    ...
    data class PacketHeader(
        ...
        val magic: Int, val version: Int, val msgType: Int, val flags: Int,

        val timestamp: Int, val sequence: Int, val payloadLength: Int
