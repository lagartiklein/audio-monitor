...
class PlantaEscenarioFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        // Apply insets to bottom buttons to avoid navigation bar overlap
        val bottomButtons = view.findViewById<LinearLayout>(R.id.bottomButtons)
...
// ============================================================
    ...
    override fun onResume() {
        ...
        // Oculta el banner (adView) siempre en Planta de Escenario
        val navView = activity.findViewById<View?>(R.id.adView)
        navView?.visibility = View.GONE
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            // Oculta la barra de herramientas si existe
            val toolbar = activity.findViewById<androidx.appcompat.widget.Toolbar?>(R.id.toolbar)
            toolbar?.visibility = View.GONE
            // Oculta la barra de navegación inferior si existe
            navView?.visibility = View.GONE
            // Oculta la barra de botones flotante
            fragmentView?.findViewById<LinearLayout?>(R.id.content_container)?.visibility = View.GONE
            // Oculta barra de estado y navegación del sistema
            val controller = window.insetsController
            controller?.hide(android.view.WindowInsets.Type.statusBars() or android.view.WindowInsets.Type.navigationBars())
            controller?.systemBarsBehavior = android.view.WindowInsetsController.BEHAVIOR_SHOW_TRANSIENT_BARS_BY_SWIPE
        } else {
            // Mostrar UI y toolbar en portrait
            val toolbar = activity.findViewById<androidx.appcompat.widget.Toolbar?>(R.id.toolbar)
            toolbar?.visibility = View.VISIBLE
            // No mostrar el banner tampoco en portrait
            navView?.visibility = View.GONE
            fragmentView?.findViewById<LinearLayout?>(R.id.content_container)?.visibility = View.VISIBLE
            // Mostrar barra de estado y navegación
            val controller = window.insetsController
