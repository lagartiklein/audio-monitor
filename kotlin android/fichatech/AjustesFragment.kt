...
class AjustesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        setupTermsConditionsButton(view)
    ...
    private fun setupPrivacyPolicyButton(view: View) {
        val btnPrivacy = view.findViewById<Button>(R.id.btn_privacy_policy)
        btnPrivacy?.setOnClickListener {
            openUrl("https://cepalabs.cl/fichatech/privacy-policy")
        }
    }

    private fun setupTermsConditionsButton(view: View) {
        val btnTerms = view.findViewById<Button>(R.id.btn_terms_conditions)
        btnTerms?.setOnClickListener {
            openUrl("https://cepalabs.cl/fichatech/terms-and-conditions")
        }
    }
