...
class NativeAudioClient(private val context: Context) {
    ...
    private fun decodeAudioPayload(
        ...
        try {
            ...
            val channelMask = buffer.int  // Ignorado, siempre 2 canales (L y R)

            val activeChannels = listOf(0, 1)  // Siempre estéreo: L y R
            ...
            val interleavedAudioData = if (isCompressed) {
                ...
                if (isInt16) {
                    ...
                    if (shortCount % 2 != 0) return null  // Debe ser múltiplo de 2 para estéreo
                    ...
                    if (floatCount % 2 != 0) return null  // Debe ser múltiplo de 2 para estéreo
            ...
            for (s in 0 until samplesPerChannel) {
                val baseIdx = s * 2
                channelsAudioData[0][s] = interleavedAudioData[baseIdx]      // L
                channelsAudioData[1][s] = interleavedAudioData[baseIdx + 1]  // R
            }
