...
class AudioMonitor {
    ...
    async connectWebSocket() {
        ...
        console.log('[AudioMonitor] Conectando WebSocket para seÃ±alizaciÃ³n...');
    ...
    async initWebRTC() {
        ...
        try {
            ...
            this.webrtcClient.onConnected = () => {
                ...
                console.log('[WebRTC] ConexiÃ³n establecida');
                ...
                // Re-suscribir canales si es reconexiÃ³n
    ...
    handleWebRTCError(errorMessage) {
        ...
        console.error('[WebRTC] Error crÃ­tico:', errorMessage);
    ...
    addProtocolControls() {
        ...
        controlsDiv.innerHTML = `
            ...
            <h3 style="margin-bottom: 15px; color: #e0e0e0;">ConfiguraciÃ³n de Protocolo</h3>
    ...
    async toggleChannel(channel, button) {
        ...
        // Iniciar audio segÃºn protocolo
    ...
    createChannelProcessor(channel) {
        ...
        try {
            ...
            // Escuchar mÃ©tricas del worklet
    ...
    updateSubscription() {
        ...
        if (this.protocol === 'websocket' && this.socket?.connected) {
            ...
            console.log('[WebSocket] SuscripciÃ³n actualizada:', channels);
    ...
    updateMetricsDisplay() {
        ...
        // Obtener mÃ©tricas segÃºn protocolo
        ...
        if (this.protocol === 'webrtc' && this.webrtcClient) {
            ...
            // Usar latencia de WebRTC para cÃ¡lculo estimado
    ...
    setupEventListeners() {
        ...
        // Detectar cambios de visibilidad de pÃ¡gina

        document.addEventListener('visibilitychange', () => {

            if (document.hidden) {

                console.log('[AudioMonitor] PÃ¡gina en segundo plano');

            } else {

                console.log('[AudioMonitor] PÃ¡gina en primer plano');
