 ...
 * CORREGIDO: Buffer mÃ¡s robusto, mejor manejo de underruns
...
class AudioProcessor extends AudioWorkletProcessor {
    ...
    constructor(options) {
        ...
        // Enviar mÃ©tricas cada ~100ms

        this.healthCheckInterval = Math.round(currentSampleRate / 10);
