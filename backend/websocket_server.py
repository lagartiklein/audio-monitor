...
Con envÃ­o de audio en tiempo real y soporte WebRTC
...
def init_server(capture, manager):
    ...
    # Iniciar thread de envÃ­o de audio
...
def start_audio_thread():
    ...
    """Inicia el thread que envÃ­a audio a los clientes"""
...
def audio_sender_loop():
    ...
    """Loop principal que envÃ­a audio a clientes conectados"""
...
def handle_disconnect():
    ...
    if webrtc_server:
        ...
        # Cerrar conexiÃ³n WebRTC tambiÃ©n
        ...
        try:
            ...
            logger.error(f"Error cerrando conexiÃ³n WebRTC: {e}")
...
def handle_webrtc_subscribe(data):
    ...
    """SuscripciÃ³n via WebRTC DataChannel fallback"""
